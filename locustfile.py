...
class OrderUser(HttpUser):
    ...
    def create_order(self):
        ...
        response = self.client.post("/v1/orders", json=payload)
        try:
    ...
    def change_order_state(self):
        try:
            ...
            if(next_state):
                ...
                self.client.patch(f"/v1/orders/{order_id}", json={"status": next_state}, name="/v1/orders/[orderId]")
        except IndexError:
            pass
...
class OrderStatus(HttpUser):
    ...
    def poll_order_status(self):
        try:
            ...
            response = self.client.get(f"/v1/orders/{order_id}/status", name="/v1/orders/[orderId]/status")
